...
window.Views['satinalma-giris'] = BasitFisOlustur({
    baslik:       'Sat\u0131nalma Giri\u015f Fi\u015fi',
    listeBaslik:  'Eklenen \u00dcr\u00fcnler',
    adetPrefix:   'x',
    adetRenk:     '#3498db',
    kaydetMesaji: 'Fi\u015f kaydedildi! (Demo)'
});

window.Views['firma-cikis'] = BasitFisOlustur({
    baslik:       'Firma \u00c7\u0131k\u0131\u015f Fi\u015fi',
    listeBaslik:  '\u00c7\u0131k\u0131\u015f Yap\u0131lan \u00dcr\u00fcnler',
    adetPrefix:   '-',
    adetRenk:     '#e74c3c',
    kaydetMesaji: 'Firma \u00e7\u0131k\u0131\u015f fi\u015fi kaydedildi! (Demo)'
});

window.Views['iade'] = BasitFisOlustur({
    baslik:       '\u0130ade Fi\u015fi',
    listeBaslik:  '\u0130ade Edilen \u00dcr\u00fcnler',
    adetPrefix:   'x',
    adetRenk:     '#3498db',
    kaydetMesaji: '\u0130ade fi\u015fi kaydedildi! (Demo)'
});
